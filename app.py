...
REGIONAL_WAREHOUSES = {
    ...
    'Kochi': ['CW Kunnamthanam', 'CW Ernakulam', 'CW Kochi (PB)', 'CW Kakkanad', 'CW Kanjikode', 'CW Kakkancherry', 'CW Trichur', 'CW Thalassery', 'CW Edathala', 'CW Kozhikode', 'CW Trivandrum', 'CW Madikkai', 'CW Kannur']
}
...
def generate_pdf():
  ...
  story.append(Paragraph(f' {warehouse}   <b> under </b>  {region} <b>Region</b> | <b>Date:</b> {date_str_dd_mm_yyyy}', subheader_style))
  story.append(Spacer(1, 0.2 * inch))
